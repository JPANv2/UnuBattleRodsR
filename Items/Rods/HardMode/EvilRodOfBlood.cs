...
{
    public class EvilRodOfBlood : BattleRod
	{
        ...
        public override float BaseVampiricPercent => 0.03f;
        ...
        public override int CrateDrop => Main.rand.NextBool() ? ItemID.CrimsonFishingCrateHard : ModContent.ItemType<SoulCrate>();
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
            // DisplayName.SetDefault("Evil Rod of Blood");
            // Tooltip.SetDefault("Provides slight life steal.");
        }
        ...
        public override void SetDefaults()
		{
            ...
            base.Item.shoot = ModContent.ProjectileType<EvilRodOfBloodBobber>();
