...
{
    public class EmptyFlamerTurret : BaseEmptyTurret
    {
        ...
        public override void AddRecipes()
        {
            ...
            rec.AddIngredient(ItemID.Flamethrower, 1);
            rec.AddTile(TileID.MythrilAnvil);
            rec.Register();
        }
    }

    public class FlamerTurret : BaseTurret
    {
        ...
        public override int EmptyTurretType => ModContent.ItemType<EmptyFlamerTurret>();
